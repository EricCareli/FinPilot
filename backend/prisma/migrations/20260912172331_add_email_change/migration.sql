...
-- CreateIndex
CREATE INDEX "email_change_codes_newEmail_idx" ON "email_change_codes"("newEmail");

-- CreateIndex
CREATE INDEX "email_change_codes_expiresAt_idx" ON "email_change_codes"("expiresAt");
